...
;(function(App) {
	 ...
	 *
	 */
	App.Core = function(motionDetectedCallback) {
        ...
        var userCallback = motionDetectedCallback;
		...
		function render() {
            ...
            console.log('compare result=' + vals.topLeft + ';' + vals.bottomRight );

            if (vals.topLeft[0] != Infinity && vals.topLeft[1] != Infinity){
                userCallback(true);
            }
			else {
				userCallback(false);
