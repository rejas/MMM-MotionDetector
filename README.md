...
| `captureWidth`               | Capture resolution width requested from the V4L2 device via `ffmpeg`. Adjust if your device does not support the default mode.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `320`         |
| `captureHeight`              | Capture resolution height requested from the V4L2 device via `ffmpeg`. Adjust if your device does not support the default mode.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `240`         |
