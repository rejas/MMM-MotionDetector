	...
	App.WebCamCapture = function(videoElement) {
		...
		function initialize(videoElement) {
			if (videoElement === undefined){
				webCamWindow = document.createElement('video');
				webCamWindow.setAttribute('autoplay', 'autoplay');
				...
				cameraPreview.appendChild(webCamWindow);

				startStream();
			} else if (typeof videoElement != 'object') {
